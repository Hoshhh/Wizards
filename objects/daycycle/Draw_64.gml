...
/*
draw_text_color(10,10, "Hour: " + string(floor(hours)), c,c,c,c, 1);
draw_text_color(10,50, "Day: " + string(day), c,c,c,c, 1);
draw_text_color(10,90, "Season: " + string(season), c,c,c,c, 1);
draw_text_color(10,130, "Year: " + string(year), c,c,c,c, 1);