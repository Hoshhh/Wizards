...
draw_sprite_part_ext(
	spr_ct_ui, 0, 0, 0, ct_ui_width, ct_ui_height, 
	ct_ui_x, ct_ui_y, scale, scale, c_white, 1);
...
for (var i = 0; i < ct_slots; i++) {
	...
	var ox = (oitem mod spr_ct_items_columns)*cell_size;
	var oy = (oitem div spr_ct_items_columns)*cell_size;
	
	var iitem = inventory[i].itemInSlot
	if (iitem > 0) {
		sx = (iitem mod spr_ct_items_columns)*cell_size;
		sy = (iitem div spr_ct_items_columns)*cell_size;	
	}
	...
	switch(i) {
		...
		case selected_slot: 
			if (iitem > 0 and i < 3) {
				draw_sprite_part_ext(spr_ct_items, 0, sx, sy, cell_size, cell_size, xx, yy, scale, scale, c_white, 1);	
			}
			
			if (mouse_in_ct and i < 3) {	
	...
	if (oitem > 0) {
		if (inventory[3].itemInSlot != item.none) {
			...
			draw_sprite_part_ext(
			spr_ct_items, 0,ox,oy,cell_size, cell_size, 
...
for (var j = 0; j < array_length(recipe_page); j++) {
	...
	if (output_item > 0) {
		recipe_output_sx = (output_item mod spr_ct_items_columns)*cell_size;
		recipe_output_sy = (output_item div spr_ct_items_columns)*cell_size;	
	}
	
	if (item1 > 0) {
		recipe_item1_sx = (item1 mod spr_ct_items_columns)*cell_size;
		recipe_item1_sy = (item1 div spr_ct_items_columns)*cell_size;	
	}
	
	if (item2 > 0) {
		recipe_item2_sx = (item2 mod spr_ct_items_columns)*cell_size;
		recipe_item2_sy = (item2 div spr_ct_items_columns)*cell_size;	
	}
	
	if (item3 > 0) {
		recipe_item3_sx = (item3 mod spr_ct_items_columns)*cell_size;
		recipe_item3_sy = (item3 div spr_ct_items_columns)*cell_size;	
	}
	#endregion
	...
	if (j == 0) {
		if (output_item > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_output_sx, recipe_output_sy, cell_size, cell_size, output_xx, recipe1_yy, scale, scale, c_white, 1);	
		...
		if (item1 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item1_sx, recipe_item1_sy, cell_size, cell_size, item1_xx, recipe1_yy, scale, scale, c_white, 1);	
		...
		if (item2 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item2_sx, recipe_item2_sy, cell_size, cell_size, item2_xx, recipe1_yy, scale, scale, c_white, 1);	
		...
		if (item3 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item3_sx, recipe_item3_sy, cell_size, cell_size, item3_xx, recipe1_yy, scale, scale, c_white, 1);	
	...
	if (j == 1) {
		if (output_item > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_output_sx, recipe_output_sy, cell_size, cell_size, output_xx, recipe2_yy, scale, scale, c_white, 1);	
		...
		if (item1 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item1_sx, recipe_item1_sy, cell_size, cell_size, item1_xx, recipe2_yy, scale, scale, c_white, 1);	
		...
		if (item2 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item2_sx, recipe_item2_sy, cell_size, cell_size, item2_xx, recipe2_yy, scale, scale, c_white, 1);	
		...
		if (item3 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item3_sx, recipe_item3_sy, cell_size, cell_size, item3_xx, recipe2_yy, scale, scale, c_white, 1);	
	...
	if (j == 2) {
		if (output_item > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_output_sx, recipe_output_sy, cell_size, cell_size, output_xx, recipe3_yy, scale, scale, c_white, 1);	
		...
		if (item1 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item1_sx, recipe_item1_sy, cell_size, cell_size, item1_xx, recipe3_yy, scale, scale, c_white, 1);	
		...
		if (item2 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item2_sx, recipe_item2_sy, cell_size, cell_size, item2_xx, recipe3_yy, scale, scale, c_white, 1);	
		...
		if (item3 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item3_sx, recipe_item3_sy, cell_size, cell_size, item3_xx, recipe3_yy, scale, scale, c_white, 1);	
	...
	if (j == 3) {
		if (output_item > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_output_sx, recipe_output_sy, cell_size, cell_size, output_xx, recipe4_yy, scale, scale, c_white, 1);	
		...
		if (item1 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item1_sx, recipe_item1_sy, cell_size, cell_size, item1_xx, recipe4_yy, scale, scale, c_white, 1);	
		...
		if (item2 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item2_sx, recipe_item2_sy, cell_size, cell_size, item2_xx, recipe4_yy, scale, scale, c_white, 1);	
		...
		if (item3 > 0) {	
			draw_sprite_part_ext(spr_ct_items, 0, recipe_item3_sx, recipe_item3_sy, cell_size, cell_size, item3_xx, recipe4_yy, scale, scale, c_white, 1);	
...
if (oMouse.itemDrag != 0) {
	...
	sx = (iitem mod spr_ct_items_columns)*cell_size;
	sy = (iitem div spr_ct_items_columns)*cell_size;	
	draw_sprite_part_ext(spr_ct_items, 0, sx, sy, cell_size, cell_size, mousex, mousey, scale, scale, c_white, 0.7);
}